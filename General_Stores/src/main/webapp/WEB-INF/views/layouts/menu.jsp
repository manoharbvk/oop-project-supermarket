			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-3 logo_agile mb-4">
					<h1 class="text-center">
						<a href="${pageContext.request.contextPath}/home" class="font-weight-bold font-italic" style="font-size: 60px;">
							<img src="${pageContext.request.contextPath}/images/logo2.png" class="img-fluid">&nbsp;Grocket
						</a>
					</h1>
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="/product/search" method="post">
								<input class="form-control mr-sm-2" type="search" name="keyword" placeholder="Search here .." aria-label="Search" required>
								<button class="btn my-2 my-sm-3" type="submit">Search</button>
							</form>
						</div>
						<!-- //search -->
						<!-- cart details -->
						<div class="col-2 top_nav_right text-center mt-sm-3 mt-2">
